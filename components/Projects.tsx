...
export default function Projects({}: Props): ReactElement {
    ...
    return (
        <motion.div initial={{
            ...
            <div className='mt-20 lg:mt-0 md:mt-0 relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/40'>
                {projects.map((project)=>(
                    ...
                    <div className='mt-16 w-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                        ...
                        <div className='space-y-10 px-0 md:px-10 max-w-6xl'>
                            ...
                            <p className='mx-5 md:mx-0 lg:mx-0 text-lg text-center md:text-left'>
                            {project.des}
                            </p>
