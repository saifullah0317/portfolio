...
export default function Skills({}: Props): ReactElement {
    return (
        <motion.div initial={{
            ...
            duration:1.5
        }} className='flex relative flex-col text-center md:text-left xl:flex-row max-w-2000px xl:px-10 min-h-screen h-[1300px] lg:h-[700px] justify-center xl:space-y-0 mx-auto items-center'>


            <h3 className='absolute top-24 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>
                
            <div className='grid grid-cols-2 md:grid-cols-3 -mb-60 md:my-0 lg:grid-cols-7 gap-0 lg:gap-5 mx-5'>
